...
::
  ...
  # cephadm shell radosgw-admin script put --infile=/rootfs/{lua-file-path} --context={prerequest|postrequest|background|getdata|putdata} [--tenant={tenant-name}] [--script-name={script-name}]
...
::
   ...
   # radosgw-admin script list --context={prerequest|postrequest|background|getdata|putdata} [--tenant={tenant-name}]
